...
public final class LauncherProtocol {
  ...
  public static final String ENV_LAUNCHER_PORT = "_SPARK_LAUNCHER_PORT";

  /** Environment variable where the secret for connecting back to the server is stored. */
  public static final String ENV_LAUNCHER_SECRET = "_SPARK_LAUNCHER_SECRET";
   ...
   */
  public static class SetAppId extends Message {
   ...
   */
  public static class SetState extends Message {

    final SparkAppHandle.State state;

    public SetState(SparkAppHandle.State state) {
      this.state = state;
    }
