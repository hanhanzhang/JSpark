...
package com.sdu.spark.utils.sizeof;
...
abstract class ObjectProfileVisitors
{
    ...
    /**
     * Factory method for creating the XML combinerMerge visitor. To create a valid
    ...
    /**
     * This visitor prints out a node in plain text format. The combinerMerge is
